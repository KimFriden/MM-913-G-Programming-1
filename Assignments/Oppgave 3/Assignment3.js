...
//hvor mange sekunder er det i 2.5 timer?
const twoHoursInSeconds = 2 * timeSetup.minutes * timeSetup.seconds;
const thirtyMinutesInSeconds = 0.5 * timeSetup.minutes * timeSetup.seconds;
const secondsInTwoPointFiveHours = twoHoursInSeconds + thirtyMinutesInSeconds;
const minutesInTwoHoundredAndThreeDays = 177120;

console.log(secondsInTwoPointFiveHours);
